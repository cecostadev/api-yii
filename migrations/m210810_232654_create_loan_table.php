 ...
 */
class m210810_232654_create_loan_table extends Migration
{
    /**
     * {@inheritdoc}
     */
    public function safeUp()
    {
        $this->createTable('{{%loan}}', [
            ...
            'date_return' => $this->dateTime()
        ]);

        $this->createIndex('idx-loan-book_id', 'loan', 'book_id');
        ...
        $this->createIndex('idx-borrower_id', 'loan', 'borrower_id');
